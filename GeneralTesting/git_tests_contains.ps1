...
#command line arguments for each executable
$args_autoTester = @($autoTester_relative_path + "tests\simple40.txt " + $autoTester_relative_path + "tests\query60.txt " + $autoTester_relative_path + "tests\git60.xml");
$args_autoTester1 = @($autoTester_relative_path + "tests\simple40.txt " + $autoTester_relative_path + "tests\query61.txt " + $autoTester_relative_path + "tests\git61.xml");
$args_autoTester2 = @($autoTester_relative_path + "tests\simple40.txt " + $autoTester_relative_path + "tests\query62.txt " + $autoTester_relative_path + "tests\git62.xml");
$args_autoTester3 = @($autoTester_relative_path + "tests\simple40.txt " + $autoTester_relative_path + "tests\query63.txt " + $autoTester_relative_path + "tests\git63.xml");
$args_autoTester4 = @($autoTester_relative_path + "tests\simple40.txt " + $autoTester_relative_path + "tests\query64.txt " + $autoTester_relative_path + "tests\git64.xml");
$args_autoTester5 = @($autoTester_relative_path + "tests\simple40.txt " + $autoTester_relative_path + "tests\query65.txt " + $autoTester_relative_path + "tests\git65.xml");
$args_autoTester6 = @($autoTester_relative_path + "tests\simple40.txt " + $autoTester_relative_path + "tests\query66.txt " + $autoTester_relative_path + "tests\git66.xml");
$args_autoTester7 = @($autoTester_relative_path + "tests\simple40.txt " + $autoTester_relative_path + "tests\query67.txt " + $autoTester_relative_path + "tests\git67.xml");
$args_autoTester8 = @($autoTester_relative_path + "tests\simple40.txt " + $autoTester_relative_path + "tests\query68.txt " + $autoTester_relative_path + "tests\git68.xml");
$args_autoTester9 = @($autoTester_relative_path + "tests\simple40.txt " + $autoTester_relative_path + "tests\query69.txt " + $autoTester_relative_path + "tests\git69.xml");
$args_autoTester10 = @($autoTester_relative_path + "tests\simple60.txt " + $autoTester_relative_path + "tests\query70.txt " + $autoTester_relative_path + "tests\git70.xml");
$args_autoTester11 = @($autoTester_relative_path + "tests\simple60.txt " + $autoTester_relative_path + "tests\query71.txt " + $autoTester_relative_path + "tests\git71.xml");
$args_autoTester12 = @($autoTester_relative_path + "tests\simple60.txt " + $autoTester_relative_path + "tests\query72.txt " + $autoTester_relative_path + "tests\git72.xml");
$args_autoTester13 = @($autoTester_relative_path + "tests\simple60.txt " + $autoTester_relative_path + "tests\query73.txt " + $autoTester_relative_path + "tests\git73.xml");
...
#"autoTester32", "autoTester34" -> can't run. dunno why.

# uncomment the line below and comment the next line dfor complete tests
...
$all_testing = @("autoTester", "autoTester1", "autoTester2", "autoTester3", "autoTester4", "autoTester5", "autoTester6", "autoTester7", "autoTester8", "autoTester9", "autoTester10", "autoTester11", "autoTester12", "autoTester13")
